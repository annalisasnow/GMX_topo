...
dictSetManualMadeByMe = {1 : {'set':['O1', 'C2', 'C3', 'C4'], 'coord' : {}, 'middle' : [0.702,  0.556,  -7.885]},
                         2 : {'set':['C1', 'C2', 'C3', 'C4', 'C5', 'C10'], 'coord' : {}, 'middle' : []},
                         3: {'set':['C5', 'C6', 'C7', 'C8', 'C9', 'C10', 'C19'], 'coord' : {}, 'middle' : []},
                         4: {'set':['C6', 'C7', 'C8', 'O7'], 'coord' : {}, 'middle' : [2.151,   -3.143, 0.248]},
                         5: {'set':['C8', 'C9', 'C11', 'C12', 'C13', 'C14'], 'coord' : {}, 'middle' : []},
                         6: {'set' : ['C13', 'C14', 'C15', 'C16', 'C17'], 'coord' : {}, 'middle' : []},
                         7: {'set':['C18'], 'coord' : {}, 'middle' : []},
                         8: {'set':['C20', 'C21', 'C22', 'C23'], 'coord' : {}, 'middle' : []},
                         9: {'set' : ['C24', 'C25', 'C26', 'C27'], 'coord' : {}, 'middle' : []}}
...
for key in dictSetManualMadeByMe:
    ...
    if len(dictSetManualMadeByMe[key]['middle']) == 0:
...
dictConnect = {1: {'seedConnected':[3, 4], 'dist':{}},
               3: {'seedConnected': [5, 6], 'dist': {}},
               4: {'seedConnected':[2, 5], 'dist':{}},
               5: {'seedConnected':[6], 'dist':{}},
               6: {'seedConnected':[8], 'dist':{}},
               }#'''
...
print(dictSetManualMadeByMe[3]['middle'], "  AND  ", dictSetManualMadeByMe[5]['middle'])
